...
<div class="controls">
<img src="<?php echo htmlentities($pid);?>/<?php echo htmlentities($row['image']);?>" width="200" height="100"> <a href="update-image1.php?id=<?php echo $row['id'];?>">Change Image</a>
</div>
</div>
...
<div class="controls">
<img src="<?php echo htmlentities($pid);?>/<?php echo htmlentities($row['image1']);?>" width="200" height="100"> <a href="update-image2.php?id=<?php echo $row['id'];?>">Change Image</a>
</div>
</div>
...
<div class="controls">
<img src="<?php echo htmlentities($pid);?>/<?php echo htmlentities($row['image2']);?>" width="200" height="100"> <a href="update-image3.php?id=<?php echo $row['id'];?>">Change Image</a>
</div>
</div>
<?php } ?>
	<div class="control-group">
