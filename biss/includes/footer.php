...
<h3>IDEAS feed</h3>
     ...
     <div class="module-body m-t-20">
        <p class="about-us"> Welcome to ideas paradise</p>
        ...
        <ul class="toggle-footer" style="">
            <li class="media">
              ...
              <li class="media">
                ...
                <div class="media-body">
                    <span><a href="#">info@biss.rw</a></span>
                </div>
            </li>
...
<!-- ============================================================= INFORMATION : END ============================================================= -->            	</div><!-- /.col -->
        ...
        <div class="container" style="text-align:center;">
			<b class="copyright">&copy; 2022 business ideas support system </b> All rights reserved.
		</div>
    </div><!-- /.links-social -->
